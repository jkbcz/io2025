...
\begin{itemize}
    ...
    \item \textbf{Harmonogram:} Reprezentuje postoje kursu na przystankach, zawiera informacje o kolejności i czasach planowanych oraz rzeczywistych.
...
\begin{itemize}
    ...
    \item Każdy \textbf{Kurs} składa się z wielu \textbf{Postojów} na \textbf{Przystankach}, ułożonych w określonej kolejności (harmonogram).
